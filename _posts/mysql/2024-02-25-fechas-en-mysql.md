...
pin: true
image:
    path: poster/mysql-trabajar-con-fechas.webp
...
### 1. Determina la cantidad de días entre el pedido y la entrega
...
### 2. Identificar pedidos con retraso
...
### 4. Verificar pedidos realizados en fin de semanas
