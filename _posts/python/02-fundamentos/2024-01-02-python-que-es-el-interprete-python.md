---
title: "Python: Qué es y cómo usar el intérprete de Python"
...
![funcionamiento del intérprete de python](python/funcionamiento-del-interprete-de-python-light.webp){: .light }
...
Supongamos que creamos un archivo llamado `saludo.py` con el siguiente contenido:

```python
nombre = "Python"
print(f"Hola desde un script en {nombre}")
```
{:file="saludo.py"}

Este archivo se guarda en el sistema y luego se ejecuta desde la Terminal con el comando:
