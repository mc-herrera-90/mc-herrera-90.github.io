---
title: "Python: Instalación de Python en diferentes S.O"
...
En este tutorial, cubriremos la instalación de Python en **Windows**, **macOS** y **Linux**, usando distintas herramientas. También revisaremos los requisitos del sistema y algunos consejos para una instalación sin problemas.
...
Las siguientes opciones ( encontradas al ejecutar el instalador con `/?`) pueden ser pasadas como argumentos:

{% tabs opciones_instalacion_silenciosa %}
{% tab opciones_instalacion_silenciosa Opciones %}
|Nombre|Descripción|
|:-----|:-----------|
...
{% endtab %}
{% tab opciones_instalacion_silenciosa Ejemplos %}
```terminal
python-3.12.1.exe /passive InstallAllUsers=1
```
{: .nolineno .typing }
```terminal
python-3.12.1.exe /uninstall /quiet
```
{: .nolineno .typing }
{% endtab %}
{% endtabs %}
